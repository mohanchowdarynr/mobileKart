...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="container flex justify-between items-center w-screen py-6 bg-gray-700 text-white mx-auto fixed top-0 left-8">
        ...
        <ul className="flex items-center text-base md:text-lg  font-semibold">
          ...
          <li className="flex mr-6 rounded-full hover:text-red-700 items-center">
            <Link to="/CartPage">
